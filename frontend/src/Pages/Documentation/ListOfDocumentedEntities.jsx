...
function ListOfDocumentationEntities() {
  ...
  const fetchVocInsertions = useCallback(async (tableName) => {
    if (tableName === "Remove") return null;
    try {
  ...
  }, [connectionVocData, editingRowData, handleSelectTable, selectedTable, tableData, vocData, vocOptions]);
  ...
  }, [handleSelectTable, selectedTable, tableData]);
